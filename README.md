...
- **FPGA & Hardware Acceleration:**
  - Xilinx Zynq-7000 (PYNQ-Z2) & Artix-7 (`xc7a200t`) FPGAs, Hardware-Software Co-Design, Embedded C Firmware
  - Post-Quantum Cryptography (PQC Crystals-Kyber / ML-KEM) Hardware Accelerators for RISC-V
  - High-Speed Vedic Multipliers (Urdhva Tiryagbhyam Sutra) & Multiply-Accumulate (MAC) Units
...
- **[design-and-implementation-of-low-power-and-low-area-risc-core-using-vedic-mathematics](https://github.com/Captain-VLSI/design-and-implementation-of-low-power-and-low-area-risc-core-using-vedic-mathematics):**  
  *Low-power, area-efficient 16-bit RISC processor core in Verilog HDL featuring a high-speed Urdhva Tiryagbhyam Vedic Multiplier and MAC unit on Xilinx Artix-7 FPGA (75.95% power reduction, 55.86% area reduction).*
...
📫 **Connect with me:** [Email](mailto:ganeshs78gani@gmail.com)
